function love.conf(t)
    ...
    t.window.title = "Just a Regular Game of Pong"	-- The window title (string)
    t.window.icon = nil                 	-- Filepath to an image to use as the window's icon (string)
    t.window.width = 884                	-- The window width (number)
    t.window.height = 390               	-- The window height (number)
